...
**计分规则**：每维度看多🟢看空🔴
- 4🟢 = 重仓、3🟢 = 可加、2v2 = 观望、3🔴 = 止盈30%、4🔴 = 清仓

**层级特殊规则**：
- 上游：即使 3🔴，只要"供给"看多，止盈幅度减半
...
```json
{
  ...
  "advice": "🔹 <b>AI芯片ETF</b>：PE88%+EPS45%+供给紧缺+情绪中性→3🟢1🔴→可持有，减仓20%保留底仓<br>🔹 <b>机器人ETF</b>：PE45%+渗透超预期+政策利好+情绪中性→4🟢→维持布局<br>🔹 <b>操作策略</b>：大跌先查原因→技术回调+隔夜反弹=加仓信号；基本面利空=真减仓",
...
| **四维引用** | 每条建议标注信号矩阵，如"PE88%(-)+EPS45%(+)+紧缺(+)+情绪中性→3🟢1🔴" |
