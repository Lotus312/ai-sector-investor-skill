...
以下搜索每次运行时将 `$TODAY` 替换为**当日日期**（格式：YYYY年MM月DD日，如 2026年05月20日）。共 **4 次搜索**：

1. **市场数据**：`"$TODAY AI板块 人工智能 半导体 机器人 算力 涨跌幅 PE估值 北向资金"`
2. **产业资讯**：`"$TODAY AI人工智能 最新新闻 政策 半导体 机器人 大模型"`
3. **基金业绩排名**：`"$TODAY AI人工智能基金 业绩排名 近一年收益率 site:fund.eastmoney.com OR site:finance.sina.com.cn"`
4. **赛道新概念**：`"$TODAY AI 人工智能 半导体 机器人 ETF 新上市 清盘 新概念"`
